...
public class ProvisionRequisitionServiceTest {
    ...
    public void addRequisition() {
    	...
    	m_requisitionservice.deleteService("Home", "roberta", "10.10.10.1", http.getServiceName());
   	    m_requisitionservice.deleteInterface("Home", "rssntn67", iface3.getIpAddr());
   	    m_requisitionservice.deleteCategory("Home", "rssntn67", category.getName());
   	    m_requisitionservice.deleteAsset("Home", "rssntn67", asset);
    	m_requisitionservice.deleteNode("Home", node.getForeignId());
